...
class DailyPurchaseStatement(models.TransientModel):
    _name = 'daily.purchase.statement'
    ...
    def print_due_report_by_salesperson(self):
        ...
        return self.env.ref('daily_purchase_statement.action_purchase_statement_report').report_action([], data=datas)
